...
class Dobot:
    ...
    def move_to(self, x, y, z, r=90, mode=MODE_PTP.MOVL_XYZ):
        return self._extract_cmd_index(self._set_ptp_cmd(x, y, z, r, mode))
    
    def jump(self, x, y, z, r=90, mode=MODE_PTP.JUMP_XYZ):
        return self._extract_cmd_index(self._set_ptp_cmd(x, y, z, r, mode))

    def rotate_joint(self, j1, j2, j3, j4, mode=MODE_PTP.MOVJ_ANGLE):
        return self._extract_cmd_index(self._set_ptp_cmd(j1,j2,j3,j4,mode))
